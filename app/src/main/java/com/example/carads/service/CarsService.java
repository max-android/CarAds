...
public class CarsService {
    ...
    public List<Car> getCars(){
        ...
        cars.add(new Car("Mercedes-Benz S",
                ...
                ,"2016","30 000 км","Черный",6500000,6.0,600,"имя38","8 333 009 00 66","name_38@post.ru","Улица 38"));



        cars.add(new Car("Mercedes-Benz C",
                "http://svtunes.ru/wp-content/uploads/2017/08/Mercedes_C-Class_Sedan_2014-1.jpg"
                ,"2015","55 000 км","Белый",2800000,1.8,150,"имя39","8 000 003 34 78","name_39@post.ru","Улица 39"));
        ...
        cars.add(new Car("Mercedes-Benz C",
                ...
                ,"2014","55 000 км","Черный",2300000,1.8,150,"имя40","8 450 333 44 22","name_40@post.ru","Улица 40"));



        cars.add(new Car("Mercedes-Benz E",
                "http://st.motortrend.com/uploads/sites/10/2015/09/2012-Mercedes-Benz-E350-sedan-front.jpg"
                ,"2010","98 000 км","Серый",1500000,2.0,180,"имя41","8 664 322 44 21","name_41@post.ru","Улица 41"));



        cars.add(new Car("Mercedes-Benz C",
                "http://avtovolgograda.ru/wp-content/uploads/2013/12/novy%60j-Mercedes-Benz-C-klass-2015-Foto-41.jpg"
                ,"2016","13 000 км","Белый",3100000,3.0,380,"имя42","8 555 333 44 00","name_42@post.ru","Улица 42"));



        cars.add(new Car("Mercedes-Benz C",
                "https://car4play.ru/uploads/gallery/UuQPvfHA7yqn.jpg"
                ,"2016","9 000 км","Белый",3400000,3.0,350,"имя43","8 111 009 35 66","name_43@post.ru","Улица 43"));



        cars.add(new Car("Mercedes-Benz C",
                "https://img.day.az/clickable/01/5/s-klass_452655_004.jpg"
                ,"2016","12 000 км","Черный",3100000,2.0,150,"имя44","8 777 222 55 11","name_44@post.ru","Улица 44"));
        ...
        cars.add(new Car("Mercedes-Benz S",
                ...
                ,"2012","45 000 км","Черный",4500000,5.0,500,"имя45","8 333 200 59 21","name_45@post.ru","Улица 45"));
        ...
        cars.add(new Car("Mercedes-Benz GLC",
                ...
                ,"2015","34 000 км","Синий",3300000,4.0,500,"имя46","8 999 770 29 11","name_46@post.ru","Улица 46"));
        ...
        cars.add(new Car("Mercedes-Benz S",
                ...
                ,"2016","23 000 км","Металлик",5400000,6.0,600,"имя47","8 444 440 70 22","name_47@post.ru","Улица 47"));
        ...
        cars.add(new Car("Mercedes-Benz S",
                "https://avatars.mds.yandex.net/get-auto/198007/catalog.21016168.775214863157627941/cattouchret"
                ,"2016","12 000 км","Металлик",6700000,6.0,600,"имя48","8 880 999 99 11","name_48@post.ru","Улица 48"));
        ...
        cars.add(new Car("Mercedes-Benz S",
                ...
                ,"2016","9 000 км","Черный",7200000,6.0,600,"имя49","8 080 900 09 01","name_49@post.ru","Улица 49"));
        ...
        cars.add(new Car("Mercedes-Benz S",
                ...
                ,"2016","9 000 км","Черный",8500000,6.0,600,"имя50","8 111 100 33 91","name_50@post.ru","Улица 50"));
        ...
        cars.add(new Car("Mercedes-Benz S",
                ...
                ,"2013","78 000 км","Золотой",3200000,4.0,400,"имя51","8 777 999 11 01","name_51@post.ru","Улица 51"));
        ...
        cars.add(new Car("Mercedes-Benz S",
                ...
                ,"2008","145 000 км","Черный",1350000,4.0,400,"имя52","8 888 222 10 33","name_52@post.ru","Улица 52"));


        cars.add(new Car("Mercedes-Benz S",
                "https://avatars.mds.yandex.net/get-auto/50005/catalog.2307753.2355218115337287476/cattouchret"
                ,"2009","145 000 км","Золотой",1150000,3.0,350,"имя53","8 333 222 10 11","name_53@post.ru","Улица 53"));



        cars.add(new Car("Mercedes-Benz S",
                "https://avatars.mds.yandex.net/get-auto/515988/catalog.6529035.2355218114363934838/cattouchret"
                ,"2005","500 000 км","Черный",600000,6.0,500,"имя54","8 330 002 99 22","name_54@post.ru","Улица 54"));


        cars.add(new Car("Mercedes-Benz S",
                "https://avatars.mds.yandex.net/get-auto/515988/catalog.6528906.2355218114363934652/cattouchret"
                ,"1998","500 000 км","Черный",200000,6.0,500,"имя55","8 654 890 07 00","name_55@post.ru","Улица 55"));


        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/193297/catalog.20743538.775214863237135259/cattouchret"
                ,"2016","50 000 км","Синий",3800000,3.0,240,"имя56","8 888 089 67 90","name_56@post.ru","Улица 56"));


        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/776173/catalog.20743538.775214863237135255/cattouchret"
                ,"2016","44 000 км","Металлик",4500000,3.0,250,"имя57","8 123 567 57 90","name_57@post.ru","Улица 57"));


        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/175972/catalog.20743538.775214863237135256/cattouchret"
                ,"2016","36 000 км","Синий",3600000,3.0,240,"имя58","8 123 077 00 00","name_58@post.ru","Улица 58"));



        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/175972/catalog.20743538.775214863237135258/cattouchret"
                ,"2016","23 000 км","Синий",3700000,2.0,180,"имя59","8 890 076 34 56","name_59@post.ru","Улица 59"));



        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/198007/catalog.9259589.2355218116943322053/cattouchret"
                ,"2013","72 000 км","Коричневый",2600000,3.5,350,"имя60","8 456 678 12 66","name_60@post.ru","Улица 60"));


        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/118771/catalog.9259589.2355218116943322084/cattouchret"
                ,"2013","98 000 км","Коричневый ",2500000,3.5,350,"имя61","8 567 123 10 60","name_61@post.ru","Улица 61"));


        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/28591/catalog.4593262.2355218115337411350/cattouchret"
                ,"2011","114 000 км","Металлик",1500000,2.0,250,"имя62","8 789 456 23 78","name_62@post.ru","Улица 62"));
        ...
        cars.add(new Car("Mercedes-Benz E",
                ...
                ,"2010","167 000 км","Металлик",1200000,3.0,250,"имя63","8 453 451 00 12","name_63@post.ru","Улица 63"));


        cars.add(new Car("Mercedes-Benz E",
                "https://avatars.mds.yandex.net/get-auto/198007/catalog.4593262.2355218115337411317/cattouchret"
                ,"2009","167 000 км","Металлик",950000,3.0,320,"имя64","8 122 000 33 18","name_64@post.ru","Улица 64"));
        ...
        cars.add(new Car("Mercedes-Benz G",
                ...
                ,"2015","42 000 км","Черный",10500000,5.5,550,"имя65","8 456 789 39 12","name_65@post.ru","Улица 65"));
        ...
        cars.add(new Car("Mercedes-Benz GLE",
                ...
                ,"2015","42 000 км","Металлик",3500000,5.5,550,"имя66","8 123 890 45 23","name_66@post.ru","Улица 66"));
        ...
        cars.add(new Car("Mercedes-Benz GL",
                ...
                ,"2015","34 000 км","Коричневый",4500000,5.5,550,"имя67","8 123 890 45 23","name_67@post.ru","Улица 67"));


        cars.add(new Car("Mercedes-Benz GL",
                "https://avatars.mds.yandex.net/get-auto/198007/catalog.8225668.2355218116052248316/cattouchret"
                ,"2013","34 000 км","Коричневый",3500000,5.5,550,"имя68","8 113 234 55 00","name_68@post.ru","Улица 68"));



        cars.add(new Car("Mercedes-Benz GL",
                "https://avatars.mds.yandex.net/get-auto/28591/catalog.4986815.2355218115337500813/cattouchret"
                ,"2010","34 000 км","Металлик",2400000,5.5,550,"имя69","8 348 122 89 43","name_69@post.ru","Улица 69"));
        ...
        cars.add(new Car("Infinity FX",
                ...
                ,"2013","125 000 км","Синий",1800000,3.7,450,"имя70","8 666 111 89 00","name_70@post.ru","Улица 70"));


        cars.add(new Car("Infinity FX",
                "https://avatars.mds.yandex.net/get-auto/175972/catalog.7955105.2355218116114028117/cattouchret"
                ,"2013","145 000 км","Синий",1600000,3.7,450,"имя71","8 678 000 19 50","name_71@post.ru","Улица 71"));


        cars.add(new Car("Infinity FX",
                "https://avatars.mds.yandex.net/get-auto/198007/catalog.7955105.2355218116114028091/cattouchret"
                ,"2013","112 000 км","Синий",1400000,3.7,450,"имя72","8 000 000 11 70","name_72@post.ru","Улица 72"));


        cars.add(new Car("Infinity FX",
                "https://avatars.mds.yandex.net/get-auto/515988/catalog.7955105.2355218116114028090/cattouchret"
                ,"2012","78 000 км","Синий",1300000,3.7,450,"имя73","8 321 444 99 78","name_73@post.ru","Улица 73"));

        cars.add(new Car("Infinity FX",
                "https://avatars.mds.yandex.net/get-auto/118771/catalog.7955105.2355218116114028092/cattouchret"
                ,"2013","45 000 км","Серый", 2500000,5.0,550,"имя74","8 567 123 98 32","name_74@post.ru","Улица 74"));



        cars.add(new Car("Infinity FX",
                "https://avatars.mds.yandex.net/get-auto/397534/catalog.2662172.2355218112587191822/cattouchret"
                ,"2011","156 000 км","Оранжевый",1200000,3.7,350,"имя75","8 098 654 21 76","name_75@post.ru","Улица 75"));



        cars.add(new Car("Infinity FX",
                "https://avatars.mds.yandex.net/get-auto/51923/catalog.2662172.2355218112589039975/cattouchret"
                ,"2010","175 000 км","Оранжевый",900000,3.7,350,"имя76","8 000 000 32 11","name_76@post.ru","Улица 76"));

        cars.add(new Car("Infinity FX",
                "https://avatars.mds.yandex.net/get-auto/175972/catalog.2662172.2355218112589039972/cattouchret"
                ,"2010","120 000 км","Оранжевый",1500000,5.0,350,"имя77","8 000 000 00 77","name_77@post.ru","Улица 77"));
        ...
        cars.add(new Car("Porsche Cayenne 958",
                ...
                ,"2012","80 000 км","Серый",2500000,5.0,550,"имя78","8 567 000 87 23","name_78@post.ru","Улица 78"));



        cars.add(new Car("Porsche Cayenne 958",
                "https://avatars.mds.yandex.net/get-auto/26126/catalog.6136700.775214863207676604/cattouchret"
                ,"2011","95 000 км","Синий",2100000,5.0,550,"имя79","8 094 789 12 45","name_79@post.ru","Улица 79"));
        ...
        cars.add(new Car("Porsche Cayenne 958",
                ...
                ,"2017","7 000 км","Серый",7500000,5.0,550,"имя80","8 000 777 77 77","name_80@post.ru","Улица 80"));

        cars.add(new Car("Mercedes-Benz GL",
                "https://avatars.mds.yandex.net/get-auto/515988/catalog.4986815.2355218115337500811/cattouchret"
                ,"2009","34 000 км","Металлик",2100000,5.5,550,"имя81","8 378 892 89 43","name_81@post.ru","Улица 81"));
